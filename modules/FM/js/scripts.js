...
function addElement(id, fileName) {
    ...
    var rowInsert = '<div id="fm_file' + id + '" class="fm_file" style="text-align: center; cursor: pointer"><div class="fm_unsellabel"><a class="fm_pre" name="' + fileName + '" id="fm_filename' + id + '"><img src="' + url + 'modules/FM/img/ftypes/unknown.png" style="width: 50px; opacity: 1.0;" alt="[FILE]" /></a><div class="fname">' + shortname + '</div><div style="color: #777; cursor: pointer" onclick="uploader()">refresh</div></div></div>';
...
function getfInfo(fname, i) {
	...
	$("#dopenfile").html("<b>Download: </b><a style='color: blue' href='" + url + "fm/attach/?did=" + did + "&filename=" + encodeURIComponent(fname) + "' id='fdname'>" + fname + "</a>");
