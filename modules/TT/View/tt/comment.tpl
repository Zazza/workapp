...
<div style="margin-left: 70px">
	...
	{% if comment.remote %}
	<div style="margin: 4px; float: left"><code><a class="attach" style="margin-right: 10px; cursor: pointer" href="{{ registry.uri }}tt/attach/?remote=1&tdid={{ comment.id }}&filename={{ part.filename }}">{{ part.filename }}</a></code></div>
	{% else %}
	<div style="margin: 4px; float: left"><code><a class="attach" style="margin-right: 10px; cursor: pointer" href="{{ registry.uri }}tt/attach/?tdid={{ comment.id }}&filename={{ part.filename }}">{{ part.filename }}</a></code></div>
	{% endif %}
	{% endfor %}
