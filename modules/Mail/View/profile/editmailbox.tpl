<form method="post" action="{{ registry.uri }}mail/boxes/?email={{ post.email }}">
...
<div style="float: left">
	...
	<p>Порт</p>
	<p><input type="text" name="out_port" id="out_port" value="{{ post.out_port }}" /></p>
	<p>SSL</p>
	<p>
...
<div id="text_area" style="float: left">
    <textarea id="wysihtml5" name="textfield" style="width: 700px; height: 300px">{{ signature }}</textarea>
</div>
...
<div style="margin-top: 20px"><input type="submit" class="btn" name="submit" value="Изменить" /></div>
