...
<table class="table table-striped table-bordered table-condensed">
	<th style="width: 20px"><input type="checkbox" id="selall" style="margin-left: 2px" /></th>
	...
	<tr class="reservclass" id="r_{{ part.id }}">
		<td><input type="checkbox" id="rc_{{ part.id }}" class="selown" /></td>
...
<!-- RESERV CONTEXT MENU -->
<div class="contextMenu" id="reservMenu" style="display: none">
	<ul class="cm">
		<li id="rc_edit"><img src="{{ registry.uri }}img/edititem.gif" class="cm_img" />Правка</li>
		<li id="rc_del"><img src="{{ registry.uri }}img/delete.png" class="cm_img" />Удалить</li>
	</ul>
</div>
...
$(".reservclass").contextMenu('reservMenu', {
    bindings: {
      'rc_edit': function(t) {
