<div class="navbar navbar-fixed-top navbar-inverse" id="topContent">
	<div class="navbar-inner">
		<div class="container" style="width: auto; padding: 0 10px; min-width: 750px">
			<ul class="nav" style="width: 166px; border-right: 1px solid #444; padding-left: 34px; margin-bottom: 1px;">
				<div class="brand" href="{{ registry.uri }}" style="padding: 5px 15px;">
				<img src="{{ registry.uri }}img/logo-small-white.png" alt="logo" border="0" />
				</div>
			</ul>
			...
			<div class="nav-collapse" style="margin-bottom: 0px;">			
				...
				$("li.dropdown i").addClass("icon-white");
				</script>
			</div>
				...
				<ul class="nav pull-right" style="padding: 2px 0 0 40px;">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" style="text-align: left;">
							...
							<li><a href="{{ registry.uri }}exit/" title="выход"><i class="icon-off"></i> выход</a></li>
						</ul>
					</li>
