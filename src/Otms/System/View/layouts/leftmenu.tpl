<ul class="nav nav-list mainMenu">
	...
	{% endif %}
	<li><a href="{{ registry.uri }}task/add/"><img alt="" src="{{ registry.uri }}img/plus-button.png" />Задача</a></li>
	...
	<a href="{{ registry.uri }}task/"><img alt="" src="{{ registry.uri }}img/left/task.png" />Задачи</a>
	</li>
	...
	<a href="{{ registry.uri }}filemanager/"><img alt="" src="{{ registry.uri }}img/folder.png" />Файловый менеджер</a>
	</li>
	...
	<a href="{{ registry.uri }}objects/lists/"><img alt="" src="{{ registry.uri }}img/g.png" />Объекты</a>
	</li>
	{% if registry.module == "objects" and registry.args.0 == "kb" %}<li class="active">{% else %}<li>{% endif %}
