...
<link rel="icon" type="image/gif" href="{{ registry.url }}favicon.png" />
<meta name="description" content="workapp" />
<meta name="keywords" content="workapp" />
<link href="{{ registry.url }}css/bootstrap.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="{{ registry.url }}js/bootstrap.min.js"></script>
<title>workapp</title>
<style>
@charset "utf-8";
/* CSS Document */
...
<img alt="logo" src="{{ registry.url }}img/logo-big.png" style="border: none; padding: 8px 20px 10px" />
