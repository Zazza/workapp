...
{% for part in data %}
    ...
    <td colspan="3" align="left">
        ...
        <a title="добавить задачу" href="{{ registry.uri }}task/add/?group={{ part.id }}" class="hover"><img border="0" src="{{ registry.uri }}img/plus-small.png" alt="plus" style="position: relative; top: 3px; margin-left: 4px"></a>
