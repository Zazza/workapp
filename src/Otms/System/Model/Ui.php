 ...
 * Ui Model class
 *
 * UI - single user info class
 * Класс для работы с данными ОДНОГО текущего пользователя
 *
...
class Ui extends Model {
	 ...
	 * 
	 * В случае успеха, сохарняет UID в сессию $_SESSION["login"]
	 * Пишет дату-время (отметку) $this->startSess авторизации
	 * 
	 * @param $login
	 * @param $pass
	 * @return TRUE
	...
	/**
	 * Заполняет значения реестра:
	 *    array $this->registry["ui"] - данные пользователя
	 *    boolean $this->registry["auth"] - статус пользователя 
	 * В случае ошибки:
	 *    session_destroy()
	 *    $this->stopSess - дата-время (отметка) logout
	 *    
	 * @param array $loginSession (сессия) - содержит $loginSession["id"] - UID текущего пользователя 
	 */	
	...
	/**
	 * Правка дополнительной информации пользователя
	 * 
	 * @param int $icq
	 * @param string $skype
	 * @param string $adres
	...
	/**
	 * Пишет дату-время (отметку) авторизации
	 * 
	 * @param int $uid
	 */
	...
	/**
	 * Пишет дату-время (отметку) logout
	*
	* @param int $uid
	*/
	...
	/**
	 * Получить время авторизации пользователя
	 * 
	 * @param int $uid
	...
	/**
	 * Получить set (настройка пользователя) по ключу
	 * 
	 * @param string $key
	 * @return array
	 */
	...
	*/
	...
	/**
	 * Добавить set (настройка пользователя) по ключу
	*
	* @param string $key
	* @param string $val
	*/
